...
public class Test04 {
	...
	//1. 冒泡排序算法实现， 空间O(n)=n^2, 时间O(n)=1, 稳定的排序算法实现;
	...
	//2. 直接选择排序算法实现， 空间O(n)=n^2, 空间O(n)=1, 不稳定的排序算法实现;
	...
	//3. 直接插入排序算法实现， 空间O(n)=n^2, 空间O(n)=1, 稳定的排序算法实现;
	...
	//6. 快速排序算法实现， 时间O(n)=nlogn, 空间O(n)=1, 不稳定的排序算法实现;
