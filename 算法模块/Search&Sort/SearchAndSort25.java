...
public class Test09 {
	...
	//1. 冒泡排序算法实现， O(n)=n^2, 空间O(n)=1, 稳定的排序;
	...
	//2. 直接选择排序算法实现， O(n)=n^2, 空间O(n)=1, 不稳定的排序;
	...
	//3. 直接插入排序算法实现， O(n)=n^2, 空间O(n)=1, 稳定的排序;
	...
	//4. 二分插入排序算法实现， O(n)=n^2, 空间O(n)=1, 稳定的排序算法
	...
	//5. 希尔排序算法实现， O(n)=nlogn ~ n^2, 空间O(n)=1, 不稳定的排序；
	...
	//8. 堆排序算法实现， O(n)=nlogn, 不稳定的排序算法实现;
